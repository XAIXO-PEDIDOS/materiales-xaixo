...
export const pages = [
  {
    ...
    description: 'Almacén de materiales de construcción en Gandia: obra y cemento, tabiquería, cubiertas, pavimentos, ferretería y pintura. Entrega coordinada a pie de obra en toda La Safor.',
    nav: 'Inicio',
    navOrder: 0,
    showInNav: false,
  },
  ...
  },
  {
    ...
    description: 'Entrega a pie de obra, tráiler directo a fábrica, cuenta de cliente y asesoramiento técnico. Servicios de XAIXO para constructoras, promotoras y autónomos en La Safor.',
    nav: 'Servicios',
    navOrder: 3,
    showInNav: true,
  },
