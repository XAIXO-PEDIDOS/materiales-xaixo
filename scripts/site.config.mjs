...
export const pages = [
  ...
  },
  {
    ...
    title: 'Catálogo de materiales de construcción en Gandia | XAIXO',
    description: 'Las 15 familias de materiales de construcción y ferretería en stock en nuestro almacén de Gandia: cemento, ladrillo, placa de yeso, tejas, aislamiento, pintura y más. Busca tu material y pide precio por WhatsApp.',
    nav: 'Productos',
    navOrder: 1,
    showInNav: true,
  },
